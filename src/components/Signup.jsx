  ...
  return (
    <div className="flex items-center justify-center">
            ...
            <div className="mb-2 flex justify-center">
                ...
                <h2 className="text-center text-2xl font-bold leading-tight text-[#350b39] font-serif">Sign up to create account</h2>
                ...
                <form onSubmit={handleSubmit(create)}>
                    <div className='space-y-5 font-bold text-[#3a3c62] font-serif'>
                        ...
                        {...register("password", {
                            required: true,})}
                        />
                        <Button type="submit" className="w-full text-[rgb(225,225,216)] bg-[#2e3171] rounded-xl">
                            Create Account
                        </Button>
                    </div>
                </form>
